...
const char help_message[] =
"Usage:\n"
"  celinda [--host=<host>] [--database=<database>] [--port=<port>]\n"
"  celinda -h | --help | --version\n"
"\n"
"Options:\n"
"  -h, --help               Show this screen.\n"
"  --version                Print version and exit.\n"
"  --host=<host>            Target host [default: localhost].\n"
"  --database=<database>    Target host [default: finance].\n"
"  -p, --port=<port>        Target port [default: 5432].\n"
"";
...
int elems_to_args(Elements *elements, DocoptArgs *args, bool help,
    ...
    for (i=0; i < elements->n_options; i++) {
        ...
        } else if (!strcmp(option->olong, "--database")) {
            args->database = option->argument;
